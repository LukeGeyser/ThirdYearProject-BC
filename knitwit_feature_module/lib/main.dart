                  ...
                  children: <Widget>[
                    Expanded(
                        child: RaisedButton(
                          ...
                          onPressed: () {
                            Navigator.of(context).push(MaterialPageRoute(builder: (context)=> fbShare()));
                    ...
                    Expanded(
                        child: RaisedButton(
                          ...
                          onPressed: (){
                            Navigator.of(context).push(MaterialPageRoute(builder: (context)=> searchRav()));
                          } ,
                    ...
                    Expanded(
                        child: RaisedButton(
                          color: Colors.cyan,
                          onPressed: () {
                            Navigator.of(context).push(MaterialPageRoute(builder: (context)=> addPhotoToProject()));
                          },
...
class fbShare extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(title: Text('FB share'),),
...
class searchRav extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Search Ravelry'),),
      body: Center(child: RaisedButton(
        onPressed: (){
...
class addPhotoToProject extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Add Photo to project'),),
      body: Center(child: RaisedButton(
        onPressed: (){
